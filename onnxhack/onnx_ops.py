...
from onnxhack.onnxed import safe_numpy, DTYPE_MAP
import numpy as np
...
def Expand(x: Tensor, shape:Tensor): return x.expand(_broadcast_shape(x.shape, tuple(int(x) for x in safe_numpy(shape))))
